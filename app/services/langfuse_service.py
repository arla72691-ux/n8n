...
def _get_prompt_templates() -> dict:
    ...
    return {
        PROMPT_APD_DRAWING: (
            ...
            "- Part/Item number(s): {{part_numbers}}\n\n"
            ...
            "- part_number_match: Do the part/item numbers in the drawing's schedule or BOM table include {{part_numbers}}? Use NOT_CHECKED if no schedule/BOM table is visible."
        ),
        PROMPT_FTP_COSTING: (
